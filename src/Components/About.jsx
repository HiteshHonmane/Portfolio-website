...
function About() {
  ...
  <div ref={aboutRef} id='about' className=' mt-36 text-6xl lg:text-8xl xl:text-8xl font-semibold @apply transition-transform duration-[0.5s] ease-[ease-out] delay-[0s] text-[rgb(222,222,222)] -translate-x-full dark:text-[rgb(71,71,71)] opacity-50 overflow-x-clip items-start absolute '>ABOUT ME</div>
</div>
