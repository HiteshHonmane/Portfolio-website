    ...
    <div className=' flex h-[100vh] w[100vw] relative border-gray-500 border-2 ' id="main">
      <div id="left-side "
        ...
        <div id="middle" className=' flex flex-col items-start px-24 '>
          ...
          <h2 className=' font-Avenir text-4xl font-bold text-[#333333]  pb-8 '> Architect Agency  </h2>

          <div className='flex '>
          <h4 className=' font-AvenirMedium text-[#333333]  text-xl font- '>Project Gallery </h4>
          <img className='h-7 m-3 ' src="src\assets\Text Icons\Dot.svg"  alt="" /> 
          <h4 className='font-AvenirMedium text-[#333333]  text-xl'>Contact Form</h4>  
          </div>
